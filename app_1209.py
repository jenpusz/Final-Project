...
def predict():
    ...
    if Final_output == 0:
         ...
         titanic_data['image'] = "static/img/d5lqc9k-e681acff-5f1f-4a9f-9251-007f7a0f41df"
    else: 
        prediction_LR= 'Survived'
        if gender == 1:
                titanic_data['image'] = "static/img/images.jfif"
        else:
            titanic_data['image'] = "static/img/titanic-survivors-lifeboat.jpg"
